    ...
    <div class="space-y-6 pb-20">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="bg-white p-4 rounded-3xl shadow-soft flex flex-col items-center justify-center">
                ...
                <span class="text-xl font-bold text-text font-rounded">{{ totalEnergy }} <span
                        class="text-xs">pts</span></span>
            </div>
            <div class="bg-white p-4 rounded-3xl shadow-soft flex flex-col items-center justify-center">
                <div class="text-3xl mb-2">✨</div>
        ...
        <div>
            <div class="flex justify-between items-center mb-3">
                ...
                <button @click="emit('change-view', 'calendar')" class="text-sm text-primary">查看全部</button>
            </div>
            <div class="space-y-3">
                <div v-if="todayTasks.length === 0" class="text-center py-8 text-gray-400 bg-white rounded-3xl">
