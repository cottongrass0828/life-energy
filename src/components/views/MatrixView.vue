<template>
  <div class="h-full flex flex-col pb-20">
    <div class="mb-3 bg-blue-50 p-3 rounded-xl text-xs text-blue-600 flex items-start gap-2  border border-blue-100">
    ...
    <div class="grid grid-cols-2 gap-3 flex-1">
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto space-y-1">
          <div
            v-for="task in tasks.filter(task => !task.completed && card.filter(task))"
            :key="task.id"
